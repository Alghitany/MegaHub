...
class AppColors {
  static const Color appMainColor = Color(0xFFE32120);
  ...
  static const Color AchievmentsColor = Color(0xFFEEEEEE);
  static const Color AchievmentsTextColor = Color(0xFF818181);

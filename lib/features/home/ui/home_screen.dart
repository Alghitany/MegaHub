                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text("MEGA Event",
                                  style: TextStyle(fontWeight: FontWeight.w800, color: AppColors.appMainColor, fontSize: 16)),
...
context.pushNamed(Routes.achievementScreen);
                        ...
                        child: FeatureCard(title: "Achievements", icon: SvgPicture.asset("assets/svgs/achivementa.svg"),)),
